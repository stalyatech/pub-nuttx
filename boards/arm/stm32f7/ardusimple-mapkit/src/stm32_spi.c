/****************************************************************************
 * boards/arm/stm32f7/ardusimple-mapkit/src/stm32_spi.c
 *
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the ardusimple-mapkit
 *   board.
 *
 ****************************************************************************/
...
void weak_function stm32_spidev_initialize(void)
{
  ...
  /* SPI3 connects to the SPI FLASH */

#ifdef CONFIG_STM32F7_SPI3
  stm32_configgpio(GPIO_SPI3_CS);    /* FLASH chip select */
#endif
}
                      ...
                      uint32_t devid, bool selected)
{
  ...
  stm32_gpiowrite(GPIO_SPI3_CS, !selected);
}
