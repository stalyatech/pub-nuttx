/****************************************************************************
 * boards/arm/stm32f7/ardusimple-mapkit/src/stm32_usbhub.c
 *
...
static int usbhub_portmap(uint8_t dn_port)
{
  switch (dn_port)
    {
      /* Downstream port 1: Logical port 4 (MCU HS) */

      case USB251X_DN1_PORT:
        return 4;

      /* Downstream port 2: Logical port 3 (XBee B) */

      case USB251X_DN2_PORT:
        return 3;

      /* Downstream port 3: Logical port 2 (XBee A) */

      case USB251X_DN3_PORT:
        return 2;

      /* Downstream port 4: Logical port 1 (MCU FS) */
