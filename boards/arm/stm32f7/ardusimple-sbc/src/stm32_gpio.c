/****************************************************************************
 * boards/arm/stm32f7/ardusimple-sbc/src/stm32_gpio.c
 *
...
static const uint32_t g_gpioinputs[BOARD_NGPIOIN] =
{
  ...
  GPIO_DIN2,          /* gpio1  */
  GPIO_DIN3,          /* gpio2  */
  GPIO_GNSS_RTKIN,    /* gpio3  */
  GPIO_GNSS_GEOIN,    /* gpio4  */
};
...
static const uint32_t g_gpiooutputs[BOARD_NGPIOOUT] =
{
  ...
  GPIO_LD2,           /* gpio10 */
  GPIO_LD3,           /* gpio11 */
  GPIO_GNSS_PWRON,    /* gpio12 */
  GPIO_XBA_PWRON,     /* gpio13 */
  GPIO_XBB_PWRON,     /* gpio14 */
  GPIO_XBA_RTKSEL,    /* gpio15 */
};
