/****************************************************************************
 * boards/arm/stm32f7/ardusimple-sbc/src/stm32_progmem.c
 *
...
int stm32_progmem_init(void)
{
  ...
  const struct ota_partition_s *part = &g_ota_partition_table[0];

  g_progmem_mtd = progmem_initialize(part->offset);
