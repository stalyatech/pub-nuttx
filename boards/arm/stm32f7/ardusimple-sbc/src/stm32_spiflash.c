...
#if defined (CONFIG_ARDUSIMPLE_SPIFLASH_SMARTFS)
...
#if defined (CONFIG_ARDUSIMPLE_SPIFLASH_LITTLEFS)
...
#if defined  (CONFIG_ARDUSIMPLE_SPIFLASH_SPIFFS)
...
#if defined (CONFIG_ARDUSIMPLE_SPIFLASH_NXFFS)
...
#elif defined (CONFIG_ARDUSIMPLE_SPIFLASH_NXFFS)
...
#elif defined (CONFIG_ARDUSIMPLE_SPIFLASH_LITTLEFS)
...
#elif defined (CONFIG_ARDUSIMPLE_SPIFLASH_SPIFFS)
