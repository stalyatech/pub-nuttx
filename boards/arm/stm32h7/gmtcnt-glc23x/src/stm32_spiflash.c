/****************************************************************************
 * boards/arm/stm32h7/gmtcnt-glc23x/src/stm32_spiflash.c
 *
...
#if defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_SMARTFS)
...
#if defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_LITTLEFS)
...
#if defined  (CONFIG_GMTCNT_GLC23X_SPIFLASH_SPIFFS)
...
#if defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_NXFFS)
...
#if defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_NONE)

  syslog(LOG_INFO, "No SPI flash file system\n");

#elif defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_SMARTFS)
...
#elif defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_NXFFS)
...
#elif defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_LITTLEFS)
...
#elif defined (CONFIG_GMTCNT_GLC23X_SPIFLASH_SPIFFS)
