...
#ifdef CONFIG_BLUETOOTH_BCM4343X_UART_MTUSIZE
#define BLUETOOTH_MAX_MTU       CONFIG_BLUETOOTH_BCM4343X_UART_MTUSIZE
#else
#define BLUETOOTH_MAX_MTU       70
#endif /* CONFIG_BLUETOOTH_BCM4343X_UART_MTUSIZE */
