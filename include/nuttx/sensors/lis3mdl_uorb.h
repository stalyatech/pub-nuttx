...
#ifndef __INCLUDE_NUTTX_SENSORS_LIS3MDL_UORB_H
#define __INCLUDE_NUTTX_SENSORS_LIS3MDL_UORB_H
...
#if defined(CONFIG_SENSORS_LIS3MDL_UORB)
...
#endif /* __INCLUDE_NUTTX_SENSORS_LIS3MDL_UORB_H */
